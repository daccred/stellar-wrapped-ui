...
export function HoldingDuration({ 
  ...
  return (
    <BaseScene backgroundImage="/backgrounds/home-bg.png" className="">
      <div className="w-full flex flex-col gap-2 text-muted">
        <StoryHeader
          title="HOLDING DURATION"
          chip={`Average Holding Duration: ${averageDuration} months`}
          chipDisplay="chip"
        />
          ...
          <div className="space-y-3 text-xs px-4">
            ...
            <div className="flex flex-col items-start gap-1">
              ...
              <span className="font-medium">
                {gasFees.savings} USDC (~54% savings)
              </span>
            </div>
            <div className="flex flex-col items-start gap-1">
              <span className="text-muted-foreground">
